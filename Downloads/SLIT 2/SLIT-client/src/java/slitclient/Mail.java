...
public class Mail extends ButtonMenu {
   ...
   JLabel topicLbl2 = new JLabel("Minner om at alle må levere logg fra git innen torsdag.");
   
   JLabel fromLbl3 = new JLabel("Amanda Olsen");
   JLabel topicLbl3 = new JLabel("Hei! Lurte på om vi kunne intervjue gruppen deres?");
   
   JLabel fromLbl4 = new JLabel("Oddvar Tengesdal");
   JLabel topicLbl4 = new JLabel("Jeg blir på lab fra klokken 13 på tirsdag, bare å stikke innom");
   
   JLabel fromLbl5 = new JLabel("Lars Martin Risdal");
   JLabel topicLbl5 = new JLabel("Gidder du å sende over databasegreiene?");
   
   JLabel fromLbl6 = new JLabel("Atilla Sjusdal");
   JLabel topicLbl6 = new JLabel("Hei. Kan vi ta en hangouts på noen swing-greier?");
   
   JLabel fromLbl7 = new JLabel("Trygve Åse Lunde");
   ...
   JTextArea displayMessage = new JTextArea("Her kommer meldingene du trykker på i innboksen din");
...
// Oppsett av container
        ...
        container.add(p2);
         ...
         // Instansierer MouseListener, som blir brukt på JLabels
    ...
    public void mousePressed(MouseEvent me) {
        if(me.getComponent() == topicLbl1) {
            displayMessage.setText("Møter er satt til Tirsdag 20.11.\n"
                    + "Tider følger under: \n"
                    + "Dårlig Oppmøte: 1130.\n"
                    + "Superboys: 1200. \n"
                    + "Bad boys: 1230\n"
